...
#include <sot-oscar/task-passing-point.h>
...
namespace dynamicgraph
{
  namespace sot
  {
    namespace oscar
    {
      ...
      /* --- DG FACTORY ------------------------------------------------------- */
      DYNAMICGRAPH_FACTORY_ENTITY_PLUGIN(TaskPassingPoint,"TaskPassingPoint");
	...
	,previousTask(0u)
      {
	taskSOUT.setFunction( boost::bind(&TaskPassingPoint::computeTaskSOUT,this,_1,_2) );
	...
	for( unsigned int i=0;i<6;++i )
      ...
      dg::sot::VectorMultiBound& TaskPassingPoint::
	...
	return task;
      ...
      void TaskPassingPoint::
      display( std::ostream& os ) const
      {
      	os << "TaskPassingPoint " << name << ": " << std::endl;
      	os << "--- LIST ---  " << std::endl;
