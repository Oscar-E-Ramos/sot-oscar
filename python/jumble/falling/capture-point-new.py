#============================================================================
#
#    Make the robot take a step following the instantaneous capture point
#
#============================================================================
...
from dynamic_graph.sot.oscar.meta_tasks_tools import FeetFollowCapturePoint, FeetToPredictedCapturePoint
from dynamic_graph.sot.dyninv.meta_task_dyn_passing_point import MetaTaskDynPassingPoint
...
# Task (passing point) for the right foot
taskPPrf = MetaTaskDynPassingPoint('PPrf',dyn,'rf','right-ankle')
