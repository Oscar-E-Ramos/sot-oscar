#============================================================================
#
#           Use a capture point task to keep the robot stable
#
#============================================================================
...
# Task for the Capture Point
taskCP = MetaTaskCapturePoint(dyn, zmp, sot, dt, name="capturePt")
...
taskrf.gain.setConstant(700)


# Task containing larger zone for the Capture Point
taskCPGreater = MetaTaskCapturePoint(dyn, zmp, sot, dt, name="capturePtGreater")
...
attime(3 
       ...
       ,(lambda: gotoNd(taskrh, (1.11, 0, 0), "000001"), "Move right hand forward")
       ,(lambda: sot.push(taskHead.task.name), "Add head")
       ,(lambda: gotoNd(taskHead, (0,0,0,0,0,0), "111000"), "Keep head orientation")
#       ,(lambda: gotoNd(taskrh, (0.3, 0, 0), "000001"), "Move right hand forward")
#       ,(lambda: sot.push(tasklh.task.name), "Add left hand")
#       ,(lambda: gotoNd(tasklh, (0.3, 0, 0), "000001"), "Move left hand forward")
...
taskCP.task.controlGain.value = 100
taskrh.feature.frame("desired")
taskrh.task.controlGain.value = 3

#attime(140,lambda: sot.pop())
# attime( 100
#         ,(lambda: sot.push(taskCP.task.name),"Add Capture Point Inequality")
#         )
